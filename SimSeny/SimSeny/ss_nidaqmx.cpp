...
void ss_initial_check(void)
{
   ...
   if (ss_capture_mode == CAPTURE_MODE_UNDEFINED) {
	 ...
	 UnicodeString message = L"OK --> if you want to simulate signals.\nCancel --> if you want to use the DAQ.\n\nSimSeny IP address and port:";
     UnicodeString NewString1;

if (InputQuery("SimSeny II: Connection port ...", message, NewString1)) {


	   //if (InputQuery("SimSeny II: Connection port ...", "\"OK\" --> if you want to simulate signals.\n\"Cancel\" --> if you want to use the DAQ.\n\nSimSeny IP address and port:", NewString)) {
